                   ...
                   ELSE
                      CASE
                         WHEN
                            ...
                            -- OR city IN (SELECT city_ascii FROM cities)
...
# # Load a small subset of the CSV to determine data types
# df = pd.read_csv('events.csv', nrows=1000)
...
# create_table_sql = f"CREATE OR REPLACE TABLE TD_ALL_EVENTS ({columns});"
